...
if($method=='configsave')
{
	...
	$ggad = stripslashes(trim(be('post','qiu_gg'))) ;
	$qbfq = stripslashes(trim(be('post','qiu_bfq'))) ;
	...
	$config['qiu']['shang'] = trim(be('post','qiu_shang'));
    $config['qiu']['djjk'] = trim(be('post','qiu_djjk'));
	$config['qiu']['gg'] = trim(be('post','qiu_gg'));
	$config['qiu']['fxst'] = trim(be('post','qiu_fxst'));
	$config['qiu']['landz'] = trim(be('post','qiu_landz'));
	$config['qiu']['gzh'] = trim(be('post','qiu_gzh'));
	$config['qiu']['miao'] = trim(be('post','qiu_miao'));
	$config['qiu']['miao2'] = trim(be('post','qiu_miao2'));
	$config['qiu']['app'] = trim(be('post','qiu_app'));
	$config['qiu']['dizhit'] = trim(be('post','qiu_dizhit'));
	$config['qiu']['dizhi'] = trim(be('post','qiu_dizhi'));
	$config['qiu']['mima'] = trim(be('post','qiu_mima'));
	$config['qiu']['bfq'] = trim(be('post','qiu_bfq'));
	$config['qiu']['tixin'] = intval(trim(be('post','qiu_tixin')));
	$config['qiu']['lanjie'] = intval(trim(be('post','qiu_lanjie')));
	$config['qiu']['mimafs'] = intval(trim(be('post','qiu_mimafs')));
	$config['qiu']['weitan'] = intval(trim(be('post','qiu_weitan')));
	$config['qiu']['weitan2'] = intval(trim(be('post','qiu_weitan2')));
	$config['qiu']['xubao'] = intval(trim(be('post','qiu_xubao')));
	$config['qiu']['yu'] = trim(be('post','qiu_yu'));
	$config['qiu']['index'] = trim(be('post','qiu_index'));
	$config['qiu']['wandan'] = trim(be('post','qiu_wandan'));
	$config['qiu']['beiyong'] = trim(be('post','qiu_beiyong'));
	$config['qiu']['cdn'] = trim(be('post','qiu_cdn'));
	$config['qiu']['weidz'] = trim(be('post','qiu_weidz'));
	$config['qiu']['tishi'] = trim(be('post','qiu_tishi'));
	$config['qiu']['pweidz'] = trim(be('post','qiu_pweidz'));
	$config['qiu']['ptishi'] = trim(be('post','qiu_ptishi'));
	$config['qiu']['jk'] = trim(be('post','qiu_jk'));
	$config['qiu']['yuqi'] = intval(trim(be('post','qiu_yuqi')));
	$config['qiu']['yu2'] = intval(trim(be('post','qiu_yu2')));
	$config['qiu']['tanqi'] = intval(trim(be('post','qiu_tanqi')));
	$config['qiu']['ptanqi'] = intval(trim(be('post','qiu_ptanqi')));
	$config['qiu']['pbts'] = intval(trim(be('post','qiu_pbts')));
	...
	if(!empty($ggad)){
		fwrite(fopen('../js/gg.js','wb'),htmltojs( $ggad ) );
	}else{ fwrite(fopen('../js/gg.js','wb'),htmltojs( " " ) ); }
		if(!empty($qbfq)){
		
		$ggadas = explode("
", $qbfq);
		$ggada = "var qbfq =".json_encode($ggadas)."
var qbfd =\"".$ggadas['0']."\"";
		fwrite(fopen('../js/cmm.js','wb'),$ggada);
	}
...
elseif($method=='config')
{
	...
	$arr=array(
		...
		array('p'=>'qiu','a'=>'tixin','c'=>$MAC['qiu']['tixin'],'t'=>0),
		array('p'=>'qiu','a'=>'yuqi','c'=>$MAC['qiu']['yuqi'],'t'=>0),	
		array('p'=>'qiu','a'=>'tanqi','c'=>$MAC['qiu']['tanqi'],'t'=>0),	
		array('p'=>'qiu','a'=>'lanjie','c'=>$MAC['qiu']['lanjie'],'t'=>0),
		array('p'=>'qiu','a'=>'ptanqi','c'=>$MAC['qiu']['ptanqi'],'t'=>0),	
		array('p'=>'qiu','a'=>'xubao','c'=>$MAC['qiu']['xubao'],'t'=>0),		
		array('p'=>'qiu','a'=>'weitan','c'=>$MAC['qiu']['weitan'],'t'=>0,'n'=>array('所有端弹','只在微信弹'),'v'=>array(0,1)),
		array('p'=>'qiu','a'=>'mimafs','c'=>$MAC['qiu']['mimafs'],'t'=>0,'n'=>array('统一密码'),'v'=>array(1)),
		array('p'=>'qiu','a'=>'weitan2','c'=>$MAC['qiu']['weitan2'],'t'=>0,'n'=>array('所有端弹','只在微信弹'),'v'=>array(0,1)),
		...
		array('p'=>'qiu','a'=>'add','c'=>$MAC['qiu']['add'],'t'=>1,'n'=>array('全端显示','仅微信显示','排除微信显示'),'v'=>array(0,1,2)),
...
elseif($method=='configplay')
{
	...
	$mac_widthmob = regMatch($fc,"var\smac_widthmob\=*\"*(\S+?)'*\"*\;");
