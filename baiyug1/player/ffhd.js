...
if(match == null){
	...
	if(ll){
	MacPlayer.Html = '<object id="Player" name="Player" showcontrol="1" type="application/npFFPlayer" width="100%" height="'+MacPlayer.Height+'" URL="'+qbfd+MacPlayer.PlayUrl+'" NextWebPage="'+MacPlayer.NextUrl+'" Autoplay="1"></object>'
	}
	else{
		MacPlayer.Install();
	}
