...
if(match == null){
	...
	if(ll){
	MacPlayer.Html = '<embed id="Player" name="Player" type="application/xfplay-plugin" width="100%" height="'+MacPlayer.Height+'"   PARAM_URL="'+qbfd+MacPlayer.PlayUrl+' PARAM_Status="1" PARAM_Autoplay="1"></embed>'
	}
	else{
		MacPlayer.Install();
	}
