...
MacPlayer.Html='<object id="Player" classid="clsid:BEF1C903-057D-435E-8223-8EC337C7D3D0" width="100%" height="'+MacPlayer.Height+'" onError="MacPlayer.Install();"><param name="URL" value="'+ MacPlayer.PlayUrl +'"><param name="NextWebPage" value="'+ MacPlayer.NextUrl +'"><param name="NextCacheUrl" value="'+ MacPlayer.PlayUrl1 +'"><param name="OnPlay" value="onPlay"/><param name="OnPause" value="onPause"/><param name="OnFirstBufferingStart" value="onFirstBufferingStart"/><param name="OnFirstBufferingEnd" value="onFirstBufferingEnd"/><param name="OnPlayBufferingStart" value="onPlayBufferingStart"/><param name="OnPlayBufferingEnd" value="onPlayBufferingEnd"/><param name="OnComplete" value="onComplete"/><param name="Autoplay" value="1"/></object>';
...
setTimeout(function(){
	if (MacPlayer.Status == true && MacPlayer.Flag==1){
		if (MacPlayer.NextUrl) {
			MacPlayer.NextWebPage = MacPlayer.NextUrl
		}
	}
},
