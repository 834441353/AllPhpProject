...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#add").click(function(){
          ...
          // window.location当前窗口跳转
          // tot.location 让最大的窗口跳转
        })

        $("#search").click(function(){
          //获取关键字
          var keyword = $(this).prev().val();
          window.location = "/index.php/Admin/Goods/showlist/keyword/"+keyword;
        })
    ...
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar">
                ...
                <input type="text" name="keyword" value="" class="dfinput">
                <input name="" id="search" type="button" class="btn" value="搜索" />
            </ul>
        </div>
        <table class="tablelist">
            ...
            <tbody>
              ...
              <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td height="100px"><img src="<?php echo (ltrim($good["goods_small_logo"],'.')); ?>" alt="未上传图片"></td>
                    <td><?php echo ($good["goods_price"]); ?></td>
                    <td><?php echo ($good["goods_number"]); ?></td>
                    <td><?php echo (date("Y-m-d H:i",$good["add_time"])); ?></td>
                    <td><?php if($good["is_del"] =='0' ): ?>隐藏<?php else: ?>显示<?php endif; ?></td>
                    <td><a href="/index.php/Admin/Goods/photos/id/<?php echo ($good["goods_id"]); ?>" class="tablelink">相册</a> <a href="#" class="tablelink"> 删除</a></td>
