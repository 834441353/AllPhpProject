			...
			<div class="goodslist mt10">
				<ul>
					...
					<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="/index.php/Home/Goods/detail/id/<?php echo ($good["goods_id"]); ?>"><img src="<?php echo (ltrim($good["goods_big_logo"],'.')); ?>" alt="" /></a></dt>
								<dd><a href="/index.php/Home/Goods/detail/id/<?php echo ($good["goods_id"]); ?>"><?php echo ($good["goods_name"]); ?></a></dt>
								<dd><strong>￥<?php echo ($good["goods_price"]); ?></strong></dt>
