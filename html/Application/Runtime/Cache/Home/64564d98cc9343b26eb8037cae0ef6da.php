		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					<ul>
						<li class="cur">
							<input type="radio" name="address" value="00009" checked="checked" />王超平 北京市 昌平区 建材城西路金燕龙办公楼一层 13555555555
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
						<li>
							<input type="radio" name="address" value="00008" />王超平 湖北省 武汉市  武昌 关山光谷软件园1号201 13333333333
							<a href="">设为默认地址</a>
							<a href="">编辑</a>
							<a href="">删除</a>
						</li>
					...
					<div action="" class="none" name="address_form">
						<ul>
							<li>
				...
				<div class="delivery_select none">
					<table>
						...
						<tbody>
							<tr class="cur">
								<td>
									<input type="radio" name="" checked="checked" />普通快递送货上门
									<select name="" id="">
			...
			<div class="pay">
				...
				<div class="pay_select none">
					<table>
						<tr class="cur">
							<td class="col1"><input type="radio" name="pay" value="0" checked="checked" />支付宝</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay" value="1" />微信支付</td>
						</tr>
						<tr>
							<td class="col1"><input type="radio" name="pay" value="2" />银行卡快捷支付</td>
						</tr>
					</table>
					<a href="javascript:;" class="confirm_btn"><span>确认支付方式</span></a>
				</div>
			</div>
			<!-- 支付方式  end-->
					...
					<form action="">
						<ul>
							<li>
								...
								<input type="radio" name="" checked="checked" class="personal" />个人
								<input type="radio" name="" class="company"/>单位
								<input type="text" class="txt company_input" disabled="disabled" />
							</li>
							<li>
								<label for="">发票内容：</label>
								<input type="radio" name="" checked="checked" />明细
								<input type="radio" name="" />办公用品
								<input type="radio" name="" />体育休闲
								<input type="radio" name="" />耗材
							</li>
						</ul>
					</form>
				...
				<table>
					...
					<tbody>
						...
						<?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="col4"><?php echo ($info["goods_buy_number"]); ?></td>
						...
						<tr>
							<td colspan="5">
								<ul>
									...
									<li>
										<span>返现：</span>
										<em>-￥<?php echo ((isset($discount) && ($discount !== ""))?($discount):0); ?></em>
									</li>
									<li>
										<span>运费：</span>
										<em>￥<?php echo ((isset($freight) && ($freight !== ""))?($freight):0); ?></em>
									</li>
									<li>
										<span>应付总额：</span>
										<em>￥<?php echo ($total["price"]); ?></em>
