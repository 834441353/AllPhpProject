...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			...
			<?php if(strtolower(CONTROLLER_NAME)== 'index' && strtolower(ACTION_NAME)== 'index' ): ?>
  ...
  <hr>
		...
		$(function(){
			...
			$(".add_btn").click(function(){
				if("<?php echo (session('uid')); ?>" > 0){
					...
					$.get('/index.php/Home/Cart/add','id='+id+'&amount='+amount+'&attrs='+attrs.substring(0,attrs.length-1),function(msg){
	...
	<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
			...
			<p style="padding-left:60px;">
					...
					合计：<span class="orange"><strong id="goods_total_price"><!--<?php echo ($number_price["price"]); ?>--></strong></span> 元
			</p>
			<p>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<?php if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pic): $mod = ($i % 2 );++$i;?>
									<?php if($i == 1 ): ?><li class="cur">
											<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($pic["pics_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($pic["pics_big"],'.')); ?>'}"><img src="<?php echo (ltrim($pic["pics_sma"],'.')); ?>"></a>
										</li>
									<?php else: ?>
										<li>
											<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($pic["pics_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($pic["pics_big"],'.')); ?>'}"><img src="<?php echo (ltrim($pic["pics_sma"],'.')); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="" method="post" class="choose">
						<ul>
							...
							<?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
								<?php if($attr["attr_sel"] == '1' ): ?><li class="product">
										<dl>
											<dt><?php echo ($attr["attr_name"]); ?>：</dt>
											<dd>
												
												
												<?php if(is_array($attr["attr_value"])): $i = 0; $__LIST__ = $attr["attr_value"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i; if($i == 1 ): ?><a class="selected" href="javascript:;"><?php echo ($value); ?> <input type="radio" name="color" value="<?php echo ($value); ?>" checked="checked" /></a>
													<?php else: ?>
														<a href="javascript:;"><?php echo ($value); ?> <input type="radio" name="color" value="<?php echo ($value); ?>" /></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								...
								<?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
									<?php if($attr["attr_sel"] == '0' ): ?><li><span><?php echo ($attr["attr_name"]); ?>：</span><?php echo ($attr["attr_value"]); ?></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
