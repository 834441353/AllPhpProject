<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"/data/wwwroot/html2/apps/admin/view/index.html";i:1511008618;s:45:"/data/wwwroot/html2/apps/admin/view/base.html";i:1511008618;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div id="topmenu" class="wst-topmenu">
    <div class="wst-topmenu-logo"><img height='70' src="__ROOT__/apps/admin/view/img/logo.png"/></div>
    <div class="wst-topmenu-welcome">
        ...
        <a href="<?php echo url('home/shops/inself'); ?>" target='_blank' class="wst-top-link">自营店铺管理</a>
        <span class="wst-space">|</span>
...
<script src="__ROOT__/apps/admin/view/js/index.js?v=<?php echo $v; ?>" type="text/javascript"></script>
