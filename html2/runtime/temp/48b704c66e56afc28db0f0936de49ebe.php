<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"/data/wwwroot/html2/apps/admin/view/main.html";i:1511008618;s:45:"/data/wwwroot/html2/apps/admin/view/base.html";i:1511008618;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<link href="__ROOT__/apps/admin/view/js/ligerui/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
<link href="__STATIC__/plugins/validator/jquery.validator.css?v=<?php echo $v; ?>" rel="stylesheet">

<link href="__ROOT__/apps/admin/view/css/style.css?v=<?php echo $v; ?>" rel="stylesheet" type="text/css" />   
<script src="__STATIC__/js/jquery.min.js"></script>  
<script src="__ROOT__/apps/admin/view/js/ligerui/js/ligerui.all.js" type="text/javascript"></script> 
...
<script src="__ROOT__/apps/admin/view/js/common.js?v=<?php echo $v; ?>"></script>
...
<div id='wstmart-accredit-tips' class='wstmart-accredit-tips'>系统检测到您未获取授权，点此<a target='_blank' href='http://www.shangtaosoft.com/index.php?m=Home&c=License&a=getWSTMartLicense'>获取系统授权码</a></div>                
     ...
     <td>
		...
		<table class="wst-form wst-summary">
		  ...
		  <tr>
			 ...
			 <td width="25%"><?php echo WSTConf("CONF.wstVersion"); ?></td>
...
<script src="__ROOT__/apps/admin/view/js/main.js?v=<?php echo $v; ?>" type="text/javascript"></script>
<script>
