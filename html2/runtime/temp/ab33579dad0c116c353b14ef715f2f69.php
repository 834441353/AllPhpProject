<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"/data/wwwroot/html2/apps/admin/view/login.html";i:1511008618;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<link href="__ROOT__/apps/admin/view/css/login.css?v=<?php echo $v; ?>" rel="stylesheet" type="text/css" />
<title>后台管理中心登录 - <?php echo WSTConf('CONF.mallName'); ?></title>
</head>
<body>
<div class="wst-lo-center">
	<div class="wst-lo">
		<div class="wst-lo-left"><img src='__ROOT__/apps/admin/view/img/left.png' height='300'/></div>
	</div>
	<div class="wst-lo">
...
<script src="__ROOT__/apps/admin/view/js/login.js?v=<?php echo $v; ?>" type="text/javascript"></script>
</body>
</html>